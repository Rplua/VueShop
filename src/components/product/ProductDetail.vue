            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="">
                                <img :src="product.img || `https://placehold.co/600x400`" class="img-fluid rounded-3"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="h3">
                                ...
                                <span class="text-danger" v-if="product.salePrice"> ${{ product.salePrice.toFixed(0) }} / sqft </span>
                            </div>
                ...
                <div class="modal-footer">
                    <a href="mailto:hello@hello.com" type="button" class="btn btn-success">Contact us</a>
