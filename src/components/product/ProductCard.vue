  ...
  <div class="col-12 col-md-6 col-lg-4">
    <div class="card h-100 border">
      <div class="position-relative">
        <img :src="product.image || `https://placehold.co/600x400`" class="card-img-top object-fit-cover"
          style="height: 200px" />
      ...
      <div class="card-body d-flex flex-column">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          <div class="fw-bold me-2 fs-5 text-muted">
            <span class="text-sucess" :style="{ textDecoration: product.salePrice ? 'line-through' : 'none' }">
              $$ {{ product.price }}/sqft
            </span>
