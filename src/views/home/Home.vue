<template>
    <div>
        <div class="bg-success w-100 position-relative overflow-hidden mb-4 py-5 d-flex align-items-center hero-section" >
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <div class="input-group mt-3 mx-auto shadow-lg rounded-4" style="max-width: 700px">
                            <input type="text" v-model="searchValue" class="form-control border-0 py-3 px-4 fs-5"
        ...
        <div id="product-list" class="container">
            ...
            <div class="row g-3 mb-4 align-items-center">
                <div class="col-md-auto">
                    <div class="d-flex flex-wrap gap-3">
                        <button v-for="(category, index) in categoryList" :key="index" class="btn px-4 py-2" :class="{
            ...
            <div>
                <div v-if="filteredProductList.length > 0" class="row g-4">
                    <ProductCard v-for="product in filteredProductList" :key="product.id" :product="product">
                    </ProductCard>
                </div>
                <div v-else>
...
export default {
    ...
    setup(props) {
        ...
        const filteredProductList = computed(() => {
            let tempArray = selectCategory.value === 'All' ? [...products.value] : products.value.filter((item) => item.category.toUpperCase() === selectCategory.value.toUpperCase())
        ...
        return { products, loading, ProductCard, categoryList, selectCategory, filteredProductList, searchValue, selectedSortOption, SORT_OPTIONS };
    },
};
</script>
<style scoped>
